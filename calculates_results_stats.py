...
def calculates_results_stats(results_dic):
    ...
    if results_stats_dic['n_images'] != 0:
        ...
        print("WARNING: Result dictionary is empty!")
   ...
   # 
    if results_stats_dic['n_dogs_img'] != 0:
        ...
        print("WARNING: No dogs images available!")
    ...
    # returning results_stats_dic dictionary that I created with this function 
